...
class ModuleRegistry {
  static final List<ModuleEntry> modules = [
    ...
    const ModuleEntry(
      ...
      accent: Color(0xFFE8E6E2), // Ice white/silver
    ),
...
// Deep violet/purple theme - mathematical sophistication
    const ModuleEntry(
      ...
      accent: Color(0xFF0C0C09), // Charcoal
    ),
// ─────────────────────────────────────────────────────
    const ModuleEntry(
...
// Indigo + cyan theme - 3 solution types inside
    const ModuleEntry(
      ...
      accent: Color(0xFF312C85), // Indigo
    ),
// ─────────────────────────────────────────────────────
