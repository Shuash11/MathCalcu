...
// MATH INPUT FIELD
// StatefulWidget â€” owns its own FocusNode so it never loses
...
class _MathInputFieldState extends State<MathInputField> {
  // FocusNode lives here â€” survives parent rebuilds
        ...
        children: [
          Expanded(
            child: TextField(
              ...
              focusNode: _focusNode, // stable focus â€” no more pausing
              style: TextStyle(
                fontSize: 18,
