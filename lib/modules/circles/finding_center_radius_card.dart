...
class FindingCenterRadiusCard extends StatefulWidget {
  const FindingCenterRadiusCard({super.key});

  @override
  State<FindingCenterRadiusCard> createState() =>
      _FindingCenterRadiusCardState();
}

class _FindingCenterRadiusCardState extends State<FindingCenterRadiusCard>
