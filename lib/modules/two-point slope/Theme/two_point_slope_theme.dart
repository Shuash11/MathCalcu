...
class TwoPointSlopeTheme {
  ...
  static Color background(BuildContext context) => context.watch<ThemeProvider>().surface;
  ...
  static Color textMuted(BuildContext context) => context.watch<ThemeProvider>().textSecondary;
  ...
  // ── Card decoration ───────────────────────────────────────
  static BoxDecoration cardDecoration(BuildContext context, {bool glowing = false}) =>
      BoxDecoration(
        ...
        boxShadow: glowing
            ...
            : [
                BoxShadow(
                  color: Colors.black.withValues(alpha: isLight(context) ? 0.05 : 0.3),
                  blurRadius: 16,
  ...
  // ── Input decoration ──────────────────────────────────────
  static InputDecoration inputDecoration(BuildContext context, String label, String hint) =>
      InputDecoration(
        labelText: label,
        hintText: hint,
