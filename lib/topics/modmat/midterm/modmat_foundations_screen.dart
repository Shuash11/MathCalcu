...
class ModmatFoundationsScreen extends StatefulWidget {
  const ModmatFoundationsScreen({super.key});

  @override
  State<ModmatFoundationsScreen> createState() =>
      _ModmatFoundationsScreenState();
}

class _ModmatFoundationsScreenState extends State<ModmatFoundationsScreen>
    with TickerProviderStateMixin {
  late final List<AnimationController> _controllers;
  late final List<Animation<double>> _fadeAnims;
  late final List<Animation<Offset>> _slideAnims;

  final List<ModuleEntry> _modules = ModmatModuleRegistry.foundationsModules;
...
class _FoundationsModuleCard extends StatefulWidget {
  final ModuleEntry module;
  final VoidCallback onTap;

  const _FoundationsModuleCard({required this.module, required this.onTap});

  @override
  State<_FoundationsModuleCard> createState() => _FoundationsModuleCardState();
}

class _FoundationsModuleCardState extends State<_FoundationsModuleCard> {
  bool _pressed = false;
  bool _hovered = false;
