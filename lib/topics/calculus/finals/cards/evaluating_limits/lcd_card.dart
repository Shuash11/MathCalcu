...
class LCDCard extends StatefulWidget {
  const LCDCard({super.key});

  @override
  State<LCDCard> createState() => _LCDCardState();
}

class _LCDCardState extends State<LCDCard> {
  bool _hovered = false;
  bool _pressed = false;

  final String title = 'By LCD';
  final String subtitle = 'Combine rational expressions using the Least Common Denominator.';
  final IconData icon = Icons.layers_rounded;
  final String route = '/topics/calculus/finals/limits/lcd';
  final Color accent = FinalsTheme.danger;
