...
class ConjugateCard extends StatefulWidget {
  const ConjugateCard({super.key});

  @override
  State<ConjugateCard> createState() => _ConjugateCardState();
}

class _ConjugateCardState extends State<ConjugateCard> {
  bool _hovered = false;
  bool _pressed = false;

  final String title = 'By Conjugate';
  final String subtitle = 'Multiply by the conjugate to eliminate indeterminate radicals.';
  final IconData icon = Icons.unfold_more_double_rounded;
  final String route = '/topics/calculus/finals/limits/conjugate';
  final Color accent = FinalsTheme.secondary;
