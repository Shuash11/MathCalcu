...
class FactoringCard extends StatefulWidget {
  const FactoringCard({super.key});

  @override
  State<FactoringCard> createState() => _FactoringCardState();
}

class _FactoringCardState extends State<FactoringCard> {
  bool _hovered = false;
  bool _pressed = false;

  final String title = 'By Factoring';
  final String subtitle = 'Simplify polynomials by canceling common factors to resolve 0/0.';
  final IconData icon = Icons.architecture_rounded;
  final String route = '/topics/calculus/finals/limits/factoring';
  final Color accent = FinalsTheme.tertiary;
