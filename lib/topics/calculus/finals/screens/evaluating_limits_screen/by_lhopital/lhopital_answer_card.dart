...
class LhopitalAnswerCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return _LhopitalAnswerCardContent(
          isCompact: isCompact,
          isMedium: isMedium,
...
class _LhopitalAnswerCardContent extends StatelessWidget {
  ...
  const _LhopitalAnswerCardContent({
