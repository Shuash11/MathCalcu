...
class LhopitalInputField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return _LhopitalInputFieldContent(
          isCompact: isCompact,
          isMedium: isMedium,
...
class _LhopitalInputFieldContent extends StatelessWidget {
  ...
  const _LhopitalInputFieldContent({
              ...
              child: ListView.builder(
                ...
                itemBuilder: (ctx, i) {
                  ...
                  return AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      color: isSelected
                          ? FinalsTheme.secondaryFor(ctx).withValues(alpha: 0.1)
                          : Colors.transparent,
