...
class LhopitalLimitScreen extends StatelessWidget {
  const LhopitalLimitScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return _LhopitalLimitScreenContent(
          isCompact: isCompact,
          isMedium: isMedium,
        );
      },
...
class _LhopitalLimitScreenContent extends StatefulWidget {
  final bool isCompact;
  final bool isMedium;

  const _LhopitalLimitScreenContent({
    required this.isCompact,
    required this.isMedium,
  });

  @override
  State<_LhopitalLimitScreenContent> createState() =>
      _LhopitalLimitScreenContentState();
}
...
class _LhopitalLimitScreenContentState
  ...
  LhopitalResult? _result;
  List<LhopitalStep> _steps = [];
                        ...
                        if (_result != null && !_isSolving) ...[
                          ...
                          LhopitalAnswerCard(
                            ...
                            onTap: () => showSolutionStepsModal(
                              ...
                              child: LhopitalStepsView(steps: _steps),
                            ),
                          ),
                        ],
                      ],
