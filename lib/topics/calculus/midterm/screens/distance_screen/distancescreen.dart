...
class _DistancescreenState extends State<Distancescreen>
  ...
  // Per-field inline errors keyed by field label (never silent on empty).
  ...
  void _onCalculate() {
    ...
    final expected = _is2D
        ? {'x1': _x1Ctrl, 'y1': _y1Ctrl, 'x2': _x2Ctrl, 'y2': _y2Ctrl}
        : {'POINT x1': _x1Ctrl, 'POINT x2': _x2Ctrl};
    final errors = <String, String?>{};
    expected.forEach((label, ctrl) {
      errors[label] = FieldValidators.number(ctrl.text, label);
    });
    if (errors.values.any((e) => e != null)) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Enter a value to solve — e.g. (1,2), (4,6)'),
  ...
  Widget _buildInputField({
    ...
    final error = _fieldErrors[label];
    return Column(
      ...
      children: [
            ...
            child: TextField(
              ...
              onChanged: (_) {
                if (_fieldErrors[label] != null) {
                  setState(() => _fieldErrors.remove(label));
                }
              },
            ),
          ),
        ...
        ResponsiveText(
          error ?? InputHints.coordinateHelper,
          style: TextStyle(
            fontSize: 11,
      ...
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          child: ResponsiveText(
            ...
            style: active
                ? TextStyle(fontSize: 13, fontWeight: FontWeight.w600, color: theme.surface)
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          ResponsiveText(
                            ...
                            style: TextStyle(fontSize: 12, color: context.watch<ThemeProvider>().accentColor,
                                shadows: [
                                  Shadow(
...
// -- Formula hint -----------------------------
                Container(
                  ...
                  decoration: BoxDecoration(color: context.watch<ThemeProvider>().accentColor.withValues(alpha: 0.06), borderRadius: BorderRadius.circular(10), border: Border.all(color: context.watch<ThemeProvider>().accentColor.withValues(alpha: 0.12))),
                  child: Row(
                    children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ResponsiveText('POINT A',
                                style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: context.watch<ThemeProvider>().accentColor, letterSpacing: 1.2)),
                  ...
                  if (_hasError)
                    ...
                    Container(
                      ...
                      child: OutlinedButton(
                        ...
                        style: OutlinedButton.styleFrom(
                          backgroundColor: context.watch<ThemeProvider>().accentColor.withValues(alpha: 0.1),
                          side: BorderSide(color: context.watch<ThemeProvider>().accentColor.withValues(alpha: 0.3)),
                    ...
                    AnimatedContainer(
                        ...
                        child: Column(
                          ...
                          children: [
                            ResponsiveText('DISTANCE',
                                style: TextStyle(fontSize: 11, fontWeight: FontWeight.w700, color: context.watch<ThemeProvider>().accentColor, letterSpacing: 1.4,
                                    shadows: [
                                      Shadow(
                                        color: context.watch<ThemeProvider>().accentColor.withValues(alpha: 0.3),
                                        blurRadius: 6,
                    ...
                    SizedBox(
                      ...
                      child: OutlinedButton.icon(
                        ...
                        style: OutlinedButton.styleFrom(
                          ...
                          backgroundColor:
                              context.watch<ThemeProvider>().accentColor.withValues(alpha: 0.08),
