...
class FindingCenterCard extends StatefulWidget {
  const FindingCenterCard({super.key});

  @override
  State<FindingCenterCard> createState() => _FindingCenterCardState();
}

class _FindingCenterCardState extends State<FindingCenterCard>
  ...
  static const Color _accent = _indigo;
                            ...
                            children: [
                              ...
                              Wrap(
                                ...
                                children: [
                                  ...
                                  _TagPill(label: 'General', color: _indigo, s: s),
