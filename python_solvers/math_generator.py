...
from gen_shared import format_dart_file
from sympy import (
...
// ignore_for_file: prefer_interpolation_to_compose_strings, curly_braces_in_flow_control_structures, unnecessary_brace_in_string_interps, unnecessary_string_interpolations, prefer_const_constructors, prefer_const_declarations, no_leading_underscores_for_local_identifiers, prefer_adjacent_string_concatenation
  ...
  static SolveResult solve(String input) {
    try {
      ...
      if (p.k == 0) {
        ...
        return SolveResult(answer: 'x = ${_fmt(zeroBoundary)}', points: [zeroBoundary], intervalNotation: '[${_fmt(zeroBoundary)}, ${_fmt(zeroBoundary)}]');
      }
