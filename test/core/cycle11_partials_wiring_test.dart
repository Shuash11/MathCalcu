// Cycle 11 Slice 3c: wiring test — Partial Derivatives registry entry
// resolves to its finals screen (the last slice of Cycle 11 Item 3).
...
void main() {
  testWidgets('Partial Derivatives registry route renders its screen',
    ...
    expect(find.textContaining('Partial Derivatives'), findsWidgets);
